...
- Desktop and mobile screenshots are produced by the running-app test at 1440px and 390px respectively; the populated waveform comes from the real WAV. The same test verifies no page overflow at 320px/390px and after doubling each element's computed font size.
