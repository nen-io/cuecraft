...
| Old asynchronous import overwrites later edit     | Request generation and document revision fence; unmount invalidates in-flight reads                                            | Browser delays file read, saves newer text, resolves read and checks refusal                       |
